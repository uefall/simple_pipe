...
本仓库将 **PM-Pipeline** 文档中的原型落实为可运行的 Python 参考实现，命名仍为 **CSPF — Configurable Stream Processing Framework**。
...
| PM-Pipeline | simple_pipe |
|-------------|-------------|
| `pipeline/common/pipeline_graph_spec.h` | `spec/graph_spec.py` |
| `pipeline/common/pipeline_builder.h` | `builder/pipeline_builder.py` |
| `nodes/core/pm_node.h` | `operators/base.py` |
| `objects/pm_frame_meta.h` | `context/frame_meta.py` |
